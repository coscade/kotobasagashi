            ...
            <td bgcolor="#ECFFDF" id=kihon>
                ...
                <div align=right>
                    <table border="0" width=500 cellpadding=0 cellspacing=0>
                        <tr>
                            <td>
                                <div id=yomimokujioo><img src=../img/point_ko.gif alt=width=22 height=17
                                                          border="0"><?= $DANJYO['danjyo_title'] ?></div>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div align=center>
                    ...
                    <div id=yomionegai>
                        「男女の違いについて」何か感じることがありましたら、<br>ぜひ、メールをください。　<? form_mail("「男女の違いについて」"); ?>メールはコチラ</a>
                        へ。<br>
                    </div>
                </div>
            </td>
