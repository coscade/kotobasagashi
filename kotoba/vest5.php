...
$KOTOBA[0] = select_kotoba(5163);
$KOTOBA[1] = select_kotoba(5171);
$KOTOBA[2] = select_kotoba(5174);
$KOTOBA[3] = select_kotoba(5172);
$KOTOBA[4] = select_kotoba(5167);
...
$CONTENTS_TITLE = "■「今日のことば」２０１９年１２月の人気ベスト５■";
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="5"><img src="/img/1pix0000.gif" alt="" width="5" height="1" border="0" /></td><br>
    <td width="60"><span class="sidemenu">出典元</span></td>
    <td id=kihon><a href=/book/view.php?sid=<?=$SOURCE[$i][source_id];?>><?=$SOURCE[$i][source_name];?></a></td>
  </tr>
  <tr>
    <td width="9"><img src="/img/list_imd.gif" alt="" width="9" height="9" border="0"></td>
