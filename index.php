    ...
    <tr valign=top>
        <td>
            ...
            <div id="kotobamidashi">
                <img src="<?= $URL ?>img/point_ko.gif" alt="" width="25" height="20" border="0">
                「今日のことば」
            </div>
            <div id="kotobanakami">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <?php if (isset($SOURCE['source_name']) && ($SOURCE['source_name'] != "")) { ?>
                        <tr>
                            <td width="9">
                                <img src="<?= $URL ?>img/list_imd.gif" alt="" width="9" height="9" border="0">
                            </td>
                            <td width="5">
        ...
        <td width="140"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="10" height="24" border="0">
            ...
            <table width="140" border="0" cellspacing="0" cellpadding="0">
                <tr valign="top">
                    <td width="5">
                        <img src="<?= $URL ?>img/list_ime.gif" alt="" width="5" height="10" border="0">
                    </td>
                    <td width="5">
                        <img src="<?= $URL ?>img/1pix0000.gif" alt="" width="5" height="1" border="0">
                    </td>
                    <td width="130">
                        <a href="<?= $URL ?>kotoba/comment.php?kid=<?= $KOTOBA['KOTOBA_ID']; ?>"
                           id="greenlink">
                            「今日のことば」の<br>
                            感想を送る→コチラ<br>
                            （気軽に書き込んで<br>
                ...
                <tr valign="top">
                    <td width="5">
                        <img src="<?= $URL ?>img/1pix0000.gif" alt="" width="5" height="10" border="0">
                    </td>
                    <td width="5">
                        <img src="<?= $URL ?>img/1pix0000.gif" alt="" width="5" height="1" border="0">
                    </td>
                ...
                <tr>
                    <td colspan="3">
                        <img src="<?= $URL ?>img/1pix0000.gif" alt="" width="5" height="20" border="0">
                    </td>
                </tr>
                <tr valign="top">
...
<table width="530" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td width="260" height="10" colspan="3">
            <img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1" height="10" border="0">
        </td>
        <td width="260" height="10" colspan="3">
            <img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1" height="10" border="0">
        </td>
