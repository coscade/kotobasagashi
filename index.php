...
<!--↓右メニュー／ことば横-->
      <table width="140" border=0 cellspacing="0" cellpadding="0">
        <tr valign="top">
          ...
          <td width="5"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="5" height="1" border=0 /></td>
          <td width="130"><a href="<?php echo $URL?>kotoba/comment.php?kid=<?php echo $KOTOBA['KOTOBA_ID'];?>" id="greenlink">「今日のことば」の<br>感想を送る→コチラ<br>（気軽に書き込んで<br>くださいね）</a><br><br></td>
        </tr>
        <tr valign="top">
          <td width="5"><img src="<?php echo $URL?>img/list_ime.gif" alt="" width="5" height="10" border="0 /"></td>
          <td width="5"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="5" height="1" border=0 /></td>
...
<?php }?>
        ...
        <tr valign="top">
          <td width="5"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="5" height="10" border="0 /"></td>
          <td width="5"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="5" height="1" border=0 /></td><form action="<?php echo $URL?>kotoba/eval.php" method="post">
          <td width="130"><div id="kotobatoukou">バックナンバー、購読<br>解除は<A href=http://www.mag2.com/m/0000158973.html target=_blank　><strong><u>「コチラから」</A></strong></u><br>
...
<table width="530" border=0 cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="10" rowspan="9"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="10" height="1" border=0 /></td>
    <td width="260" height="30" colspan="3"><div id="yomikata"><h3><a href=yomikata/01.php>本の読み方＆おすすめの本</a></h3></div></td>
  </tr>
  <tr>
    <td width="260" colspan="3" bgcolor="#B2DF7D"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
    <td width="260" colspan="3" bgcolor="#B2DF7D"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
  </tr>
  <tr valign="top">
    <td width="1" bgcolor="#B2DF7D"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
    <td width="258">
<!--↓下４つのコンテンツ／男女の違いについてまとめました-->
      ...
      <li><a href="http://www.kotobasagashi.net/book/list.php?sc=1" id="greenlink">「男女・恋愛の本」</a><img src="http://www.kotobasagashi.net/img/newgs.gif" alt="" width="27"
height="15" border="0"></li>
            <li><a href="http://www.kotobasagashi.net/book/list.php?sc=2" id="greenlink">「愛・夫婦・結婚の本」</a><img src="http://www.kotobasagashi.net/img/newgs.gif" alt="" width="27"
height="15" border="0"></li>
...
<!--↑下４つのコンテンツ／まゆのお気軽本の読み方-->
  ...
  <tr>
      <td width="260" height="10" colspan="3"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="10" border=0 /></td>
      <td width="260" height="10" colspan="3"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="10" border=0 /></td>
  </tr>
  <tr>
<?php
...
?>
    <td width="260" height="30" colspan="3"><div id="question"><h3>アンケート　<?php echo $ENQ_TITLE;?></h3></div></td>
...
<!--↑下４つのコンテンツ／募集-->
  ...
  <tr>
    <td width="260" bgcolor="#B2DF7D" colspan="3"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
    <td width="260" bgcolor="#B2DF7D" colspan="3"><img src="<?php echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
  </tr>
</table>
<!--↑下４つのコンテンツ-->
