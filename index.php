...
<!--↓右メニュー／ことば横-->
      <table width="140" border=0 cellspacing="0" cellpadding="0">
        <tr valign="top">
          ...
          <td width="5"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="5" height="1" border=0 /></td>
          <td width="130"><a href="<?echo $URL?>kotoba/comment.php?kid=<?echo $KOTOBA['KOTOBA_ID'];?>" id="greenlink">「今日のことば」の<br>感想を送る→コチラ<br>（気軽に書き込んで<br>くださいね）</a><br><br></td>
        </tr>
        <tr valign="top">
          <td width="5"><img src="<?echo $URL?>img/list_ime.gif" alt="" width="5" height="10" border="0 /"></td>
          <td width="5"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="5" height="1" border=0 /></td>
...
<table width="530" border=0 cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="10" rowspan="9"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="10" height="1" border=0 /></td>
    <td width="260" height="30" colspan="3"><div id="yomikata"><h3><a href=yomikata/01.php>本の読み方＆おすすめの本</a></h3></div></td>
  </tr>
  <tr>
    <td width="260" colspan="3" bgcolor="#B2DF7D"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
    <td width="260" colspan="3" bgcolor="#B2DF7D"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
  </tr>
  <tr valign="top">
    <td width="1" bgcolor="#B2DF7D"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
    <td width="258">
...
?>
    <td width="260" height="30" colspan="3"><div id="question"><h3>アンケート　<?echo $ENQ_TITLE;?></h3></div></td>
  ...
  <tr valign="top">
    ...
    <td width="258">
<!--↓下４つのコンテンツ／アンケート-->
      <form action="<?echo $URL;?>enq.php" method="post">
      <p class="naiyou">
      <?echo $ENQ_INFO;?>
...
?>
      ...
      <input type=hidden name=submit value=修正>
      <input type=hidden name=enq_id value=<?echo $ENQ_ID;?>>
      </form>
<!--↑下４つのコンテンツ／アンケート-->
    </td>
    <td width="1" bgcolor="#B2DF7D"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
...
<!--↑下４つのコンテンツ／募集-->
  ...
  <tr>
    <td width="260" bgcolor="#B2DF7D" colspan="3"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
    <td width="260" bgcolor="#B2DF7D" colspan="3"><img src="<?echo $URL?>img/1pix0000.gif" alt="" width="1" height="1" border=0 /></td>
  </tr>
</table>
<!--↑下４つのコンテンツ-->
