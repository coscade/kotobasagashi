...
<a href=news.php>新規登録</a>　ID検索<input type=text name=news_id value="">　テキスト検索<input type=text name=key value="<?=$KEY?>">　<input type=submit value="検索">
...
?>
  <tr valign=top>
    ...
    </td><input type=hidden name=news_id value=<?= $NEWS_ID;?>></form>
  </tr>
<?php }?>
</table>
