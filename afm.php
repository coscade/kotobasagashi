...
?>
	<tr>
		<td id=kihon><a href="afm_list.php?afm_category_sub_id=<?= nl2br($afm_category_sub_list[$j][afm_category_sub_id])?>" id=categorylink><?= nl2br($afm_category_sub_list[$j][afm_category_sub_name])?></a> (<?=$afm_category_sub_list[$j][afm_num]?>件)</td>
	</tr>
<?php }?>
</table>
<br>
