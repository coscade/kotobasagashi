...
?>
    ...
    <font color=#2A7F3A><br><B>
            ...
            <form action="afm_list.php">　　◆アファメーションを文字で検索する：<input type=text name=keyword size=20><input type=submit
                                                                                                             value="検索">
            </form></font></B><br>
...
for ($i = 0; $i < $NUM; $i++) {
    ...
    <table width="100%" cellspacing="0" cellpadding="2" border="0" bordercolor=dddddd>
        ...
        for ($j = 0; $j < $NUM2; $j++) {
            ...
            <tr>
                <td id=kihon><a
                            href="afm_list.php?afm_category_sub_id=<?= nl2br($afm_category_sub_list[$j][afm_category_sub_id]) ?>"
