...
?><span class="naiyou">　　現在の登録件数　ことば：<b><a href="<?= $URL ?>kotoba/list.php"><?= $KOTOBA_NUM; ?></a></b>件</span>　
                        ...
                        <?php if (($SOURCE['source_name'] != "")) { ?>
                            <tr>
                                ...
                                <td id="kihon"><a
                                    ...
                                    <a href="http://www.amazon.co.jp/exec/obidos/ASIN/<?= $SOURCE['source_asin']; ?>/aaaaea00-22/250-3071692-7411426?creative=1615&camp=243&adid=0YENTCV4RW688GXCBBX7&link_code=as1"
                                       target="_blank">amazonで見る</a></td>
                            </tr>
                            <tr>
                                <td width="9"><img src="<?= $URL ?>img/list_imd.gif" alt="" width="9" height="9"
                                                   border="0"></td>
                ...
                <table width="140" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        ...
                        <td width="130"><a href="<?= $URL ?>kotoba/comment.php?kid=<?= $KOTOBA['KOTOBA_ID']; ?>"
                                           id="greenlink">「今日のことば」の<br>感想を送る→コチラ<br>（気軽に書き込んで<br>くださいね）</a><br><br>
                        </td>
                    </tr>
                    <tr valign="top">
                        <td width="5"><img src="<?= $URL ?>img/list_ime.gif" alt="" width="5" height="10" border="0 /">
    ...
    <table width="530" border=1 cellspacing="0" cellpadding=5>
        <tr bordercolor="#B2DF7D" bgcolor="#B2DF7D">
            <td><span class="sidemenu"><img src=../img/point_ko2.gif alt=width=22 height=17
                                            border="0">「ことば探し」のお知らせ<img src=../img/point_ko.gif alt=width=22 height=17
                                                                          border="0"></td>
        </tr>
    ...
    <table width="530" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="260" colspan="3" bgcolor="#B2DF7D"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1"
                                                               height="1" border="0"/></td>
            <td width="260" colspan="3" bgcolor="#B2DF7D"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1"
                                                               height="1" border="0"/></td>
        </tr>
        <tr valign="top">
            <td width="1" bgcolor="#B2DF7D"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1" height="1"
                                                 border="0"/></td>
            <td width="258">
            ...
            <td width="258">
                ...
                <div id="links">
                    <ul>
                        ...
                        <li><a href="yomikata/books.php" id="greenlink">本の読み方内で紹介している<br>読んでみて！「おすすめ本一覧」</a>
                        </li>
                        <li><a href="yomikata/reading.php" id="greenlink">今日の「おすすめ本」(毎日UP)</a></li>


                        <li><a href="yomikata/books2.php" id="greenlink">「夫婦関係を考えるおすすめ本　３２冊」</a></li>
                        <img src="/img/up04.gif" alt="" width="25" height="13" border="0">
        ...
        <tr>
            <td width="260" height="10" colspan="3"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1" height="10"
                                                         border="0"/></td>
            <td width="260" height="10" colspan="3"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1" height="10"
                                                         border="0"/></td>
        </tr>
        ...
        <tr>
            <td width="260" bgcolor="#B2DF7D" colspan="3"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1"
                                                               height="1" border="0"/></td>
            <td width="260" bgcolor="#B2DF7D" colspan="3"><img src="<?= $URL ?>img/1pix0000.gif" alt="" width="1"
                                                               height="1" border="0"/></td>
        </tr>
