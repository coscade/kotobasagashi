    ...
    <div id=hajimemashite>
        ...
        <div ><br>
            ...
            　　<img src=../img/point_ko.gif alt=width=22 height=17 border="0"><img src=../img/point_ko.gif alt=width=22
                                                                                  height=17 border="0">　<strong>４０秒で読む！　幸せ「ことば探し」</strong><img
                    src=../img/point_ko.gif alt=width=22 height=17 border="0"><img src=../img/point_ko.gif alt=width=22
                                                                                   height=17 border="0"><br><br>
            ...
            <img src=../img/point_ko.gif alt=width=22 height=17 border="0"><strong>お申し込みは<A
