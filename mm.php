...
<div id="hajimemashite">
    ...
    <img src="/img/point_ko.gif" width="22" height="17">　
    <strong>４０秒で読む！　幸せ「ことば探し」</strong>
    <img src="/img/point_ko.gif" width="22" height="17">
    <img src="/img/point_ko.gif" width="22" height="17"><br><br>
    ...
    <form action="http://regist.mag2.com/reader/Magrdadd" method="POST">
        <img src="/img/point_ko.gif" width="22" height="17">登録フォーム（よろしくおつきあいください）<br>
    ...
    <form action="http://regist.mag2.com/reader/Magrddel" method="POST">
        <img src="/img/point_ko.gif" width="22" height="17">解除フォーム（どーも、ありがとうございました！）<br>
        <input type="hidden" name="magid" value="0000158973">
        <input type="text" name="rdemail" value="">
        <input type="hidden" name="reg" value="hakkou">
